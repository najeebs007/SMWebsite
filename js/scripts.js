...
;(function () {
    ...
    $(document).ready(function () {
		...
		if ($('.main-benefits').length > 0) {

            $('.main-benefits').owlCarousel({ 
				loop:true,
                margin:26,
...
/* === Latest client Carousel === */
		...
		jQuery(window).on('scroll', function() {
			if (jQuery(this).scrollTop() > offset) {
				jQuery('.scroll-to-bottom').fadeIn(duration);
			} else {
				jQuery('.scroll-to-bottom').fadeOut(duration);
			}
		}); 
		$(function () {
