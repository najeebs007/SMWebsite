(function (namespace, $) {
	...
	p._initDatePicker = function () {
		...
		$('#demo-date3').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date4').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date5').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date6').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date7').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date8').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date9').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date10').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date11').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date12').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date13').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date14').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
		$('#demo-date15').datepicker({autoclose: true, todayHighlight: true,format: "dd/mm/yyyy"});
